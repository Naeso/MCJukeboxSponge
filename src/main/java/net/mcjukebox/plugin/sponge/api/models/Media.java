...
public class Media {
    ...
    public Media(ResourceType type, String URL, MCJukebox instance) {
    ...
    public Media(ResourceType type, String URL, JSONObject options,  MCJukebox instance) throws JSONException {
        this.currentInstance = instance;
    ...
    public void loadOptions(JSONObject options) throws JSONException {
        ...
        if(options.has("startTime")) {
            if(options.get("startTime") instanceof String && options.getString("startTime").equalsIgnoreCase("now")) {
                startTime = currentInstance.getTimeUtils().currentTimeMillis();
